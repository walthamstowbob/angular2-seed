...
@Component({
    ...
    `],
    directives: [ChangePasswordFormComponent, SignUpFormComponent, SubscriptionFormComponent, ContactFormComponent, ZippyComponent, TweetComponent, VoteComponent, LikeComponent, FavoriteComponent, CoursesComponent, AuthorsComponent, ArtistsComponent],
